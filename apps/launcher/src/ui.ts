...
export class WidgetUI {
  ...
  private renderButtonIdleContent(): void {
    ...
    Object.assign(this.launcherPlaceholderEl.style, {
      ...
      backgroundClip: 'text',
      font: '700 13px/1.2 "Hanken Grotesk", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
      letterSpacing: '0',
      opacity: '1',
    ...
    Object.assign(this.launcherInput.style, {
      ...
      color: '#1f2933',
      font: '600 13px/1.2 "Hanken Grotesk", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
      letterSpacing: '0',
