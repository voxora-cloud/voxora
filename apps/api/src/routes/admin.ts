...
// Create team
router.post("/teams", validateRequest(teamValidation.create), createTeam);

// Update team
router.put("/teams/:id", validateRequest(teamValidation.update), updateTeam);
...
router.put("/widget", validateRequest(widgetValidation.update), updateWidget);
