    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <Label htmlFor="password">
          Password {agent && <span className="text-xs text-muted-foreground">(leave empty to keep current)</span>}
        </Label>
        <div className="relative">
          <Input
            ...
            placeholder={agent ? "Leave empty to keep current password" : "Enter agent password"}
