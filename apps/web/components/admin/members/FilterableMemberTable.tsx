...
import { Edit, Mail, Search, Trash2, User, X, PowerOff, Power } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function FilterableMemberTable({
  members,
  teams,
  onEditMember,
  onDeleteMember,
              ...
              >
                <td className="px-4 py-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-emerald-600 flex items-center justify-center text-white font-bold text-sm">
                      {member.user?.name?.charAt(0) ||
                        member.user?.email?.charAt(0).toUpperCase() || "A"}
                    </div>
                    <div>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center">
                    <span className="text-sm font-medium capitalize text-zinc-300">{member.role}</span>
                  </div>
                </td>
                  ...
                  <div className="flex items-center justify-end space-x-2">
                    ...
                    {member.user?._id !== currentUserId ? (
                      (() => {
                        ...
                        const canManageRow = activeRole === "owner" || (activeRole === "admin" && targetRole === "agent");

                        if (!canManageRow) {
                          return <span className="text-xs text-muted-foreground mr-2">Restricted</span>;
                        }
                        ...
                        return (
                          <>
                            <Button
                              ...
                              title={member.inviteStatus === "inactive" ? "Reactivate Member" : "Suspend Member"}
                            >
                      ...
                      <span className="text-xs text-muted-foreground mr-2 italic">You</span>
                    )}
                  </div>
                </td>
              </tr>
