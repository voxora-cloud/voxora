      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-20 items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button className="bg-gradient-to-r from-primary to-primary shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30 transition-shadow" asChild>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-primary/10 text-primary mb-6">
                <span className="text-xs font-medium">New: Omnichannel Support</span>
              </div>
              ...
              <div className="mt-8 flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-sm text-muted-foreground">From startups to enterprises</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative bg-card rounded-xl shadow-2xl overflow-hidden border border-border">
                <div className="p-4 bg-muted/50 border-b border-border flex items-center space-x-2">
                  ...
                  <div className="text-xs font-medium">Voxora Chat Interface</div>
                </div>
                <div className="p-6 space-y-4">
                  <div className="bg-muted rounded-lg p-3 max-w-xs">
                    <p className="text-sm">Hi! How can I help you today?</p>
                    <span className="text-xs text-muted-foreground">Support Agent • 2m ago</span>
                  </div>
                  <div className="bg-primary rounded-lg p-3 max-w-xs ml-auto text-primary-foreground">
                    ...
                    <span className="text-xs text-primary-foreground/80 text-right block">You • Just now</span>
                  </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground">
              ...
              Our platform combines ease of use with powerful capabilities.
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-primary/10 via-background to-accent/10 rounded-2xl p-8 shadow-xl border border-border">
                <div className="bg-card rounded-xl p-6 shadow-lg border border-border/40">
                  <div className="flex items-center space-x-3 pb-4 border-b border-border/50 mb-4">
                    ...
                    <div>
                      <div className="text-sm font-medium">Voxora Assistant</div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-muted rounded-lg p-4 max-w-xs">
                      <p className="text-sm">Hi! How can I help you today?</p>
                      <span className="text-xs text-muted-foreground mt-1 block">12:03 PM</span>
                    </div>
                    <div className="bg-primary rounded-lg p-4 max-w-xs ml-auto text-primary-foreground">
                      ...
                      <span className="text-xs text-primary-foreground/80 mt-1 block">12:04 PM</span>
                    </div>
                    <div className="bg-muted rounded-lg p-4 max-w-xs">
                      <p className="text-sm">I&apos;d be happy to help! Let me look into that for you.</p>
                      <span className="text-xs text-muted-foreground mt-1 block">12:04 PM</span>
                    </div>
                  </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 opacity-10 -z-10">
          <svg width="400" height="400" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 10L90 10L90 90L10 90L10 10Z" stroke="white" strokeWidth="4"/>
            <path d="M30 30L70 30L70 70L30 70L30 30Z" stroke="white" strokeWidth="4"/>
      ...
      <footer className="border-t border-border bg-muted/30">
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-muted-foreground text-sm mb-4 max-w-xs">
                Enterprise-grade customer support platform designed for modern teams.
                Open source, secure, and built for scale.
              </p>
          ...
          <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 md:mb-0">&copy; 2025 Voxora. All rights reserved. Made with ❤️ by the open source community.</p>
