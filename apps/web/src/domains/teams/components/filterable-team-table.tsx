...
import { Edit, Loader2, Search, Trash2, Users, X } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
interface FilterableTeamTableProps {
  ...
  updatingTeamId?: string;
  deletingTeamId?: string;
}

export function FilterableTeamTable({
  teams,
  onEditTeam,
  onDeleteTeam,
  onViewDetails,
        ...
        <table className="w-full text-sm">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="with-agents" className="cursor-pointer">With Agents</SelectItem>
                      <SelectItem value="no-agents" className="cursor-pointer">No Agents</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </th>
          ...
          <tbody>
            {paginatedTeams.map((team) => {
              const isCreating = creatingTeamId === team._id;
              const isUpdating = updatingTeamId === team._id;
              const isDeleting = deletingTeamId === team._id;
                    ...
                    {isProcessing ? (
                      <div className="flex items-center space-x-2 text-muted-foreground">
                        ...
                        <span className="text-sm">
                          {isCreating ? "Creating..." : isDeleting ? "Deleting..." : "Updating..."}
                        </span>
                      </div>
                    ) : (
                      <>
