        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 h-12 rounded-sm border-border/60 bg-muted/30 focus:bg-background transition-colors cursor-text ${fieldErrors.email && touched.email ? "border-destructive" : ""
                }`}
              disabled={isPending}
            />
          </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 pr-11 h-12 rounded-sm border-border/60 bg-muted/30 focus:bg-background transition-colors cursor-text ${fieldErrors.password && touched.password ? "border-destructive" : ""
                }`}
              disabled={isPending}
            />
            <button
