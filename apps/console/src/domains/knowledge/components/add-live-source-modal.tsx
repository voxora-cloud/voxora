    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px]">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-semibold text-foreground">Add Live Source</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                />
                <div className="flex-1">
                  <div className="font-medium text-foreground">Crawl Subpages</div>
                  <div className="text-sm text-muted-foreground mt-1">
                    ...
                    <div className="mt-3">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFormData((prev) => ({
                            ...prev,
                            crawlDepth: Number.parseInt(value, 10),
                          }))
                        }
                      >
            ...
            <div className="p-4 bg-muted rounded-lg space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="text-foreground">
                  {getSyncFrequencyLabel(formData.syncFrequency || "manual")}
                </div>
              </div>
            </div>
